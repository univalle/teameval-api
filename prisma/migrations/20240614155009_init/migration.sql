/*
  ...
  - Added the required column `evaluatedStudentId` to the `CriteriaStudentResult` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "CriteriaStudentResult" ADD COLUMN     "evaluatedStudentId" INTEGER NOT NULL;
...
-- AddForeignKey
ALTER TABLE "CriteriaStudentResult" ADD CONSTRAINT "CriteriaStudentResult_evaluatedStudentId_fkey" FOREIGN KEY ("evaluatedStudentId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
